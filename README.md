...
* Open the R console and set your working directory to the folder holding the scripts and text file. Clear the environment and remove objects if necessary.
